...
def set_PEPC_C3_constraints(model, slope=2.094050238268857, objective = "Marchantia_biomass"):
    """
    ...
    PEPC_obj_const = model.problem.Constraint(
            (slope*(model.reactions.get_by_id(objective).flux_expression)-0.004094236757268383) -
            (model.reactions.PEPCARBOX_RXN_c_12.flux_expression) , 
            lb = 0,
...
def plot_eO_iteration_results(df):
    ...
    ax2.axhline(y=6, color='gray', linestyle='dotted', label='expt. CO2 uptake')
